...
// SearchGraphQLRequester creates a valid Search service request compliant with the schema,
// ResolveScale is an indicator of the number of option's fields requested
